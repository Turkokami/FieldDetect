...
>(({ className, children, label, error, helperText, id, ...props }, ref) => {
  const triggerId = id || (label ? label.toLowerCase().replace(/\s+/g, '-') : undefined)
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ref={ref}
    className={cn(
      'relative flex w-full cursor-default select-none items-center rounded-md py-2 pl-8 pr-3 text-sm text-gray-700',
      'outline-none',
